...
const DICT = {
  ru: {
    ...
    "err.time_taken": "Это время только что заняли. Пожалуйста, выберите другое",
  ...
  uk: {
    ...
    "err.time_taken": "Цей час щойно зайняли. Будь ласка, оберіть інший",
  ...
  en: {
    ...
    "err.time_taken": "This time was just booked. Please choose another one",
